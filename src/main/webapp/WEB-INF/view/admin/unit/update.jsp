<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                <title>Cập nhật unit - Fruitables</title>
                            ...
                            <main class="mb-3">
                                <div class="container-fluid px-4">
                                    ...
                                    <div class="col col-md-10 mx-auto">
                                        <h3 class="mb-3">Sửa đơn vị</h3>
                                        <hr>
                                        <form:form enctype="multipart/form-data" modelAttribute="currentUnit"
                                            method="post" action="/admin/unit/update">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-12 col-md-6 mt-md-0 mt-3">
                                                    ...
                                                    <form:input type="text-center" class="form-control" id="name"
