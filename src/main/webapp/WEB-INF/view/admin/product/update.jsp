<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                <title>Cập nhật sản phẩm - Fruitables</title>
                            ...
                            <main class="mb-3">
                                <div class="container-fluid px-4">
                                    ...
                                    <div class="col col-md-10 mx-auto">
                                        <h3 class="mb-3">Sửa một sản phẩm</h3>
                                        <hr>
                                        <form:form enctype="multipart/form-data" modelAttribute="currentProduct"
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div id="avatarPreviewContainer">
                                                        <img class="mx-auto" style="max-height: 250px; display: none;"
                                                            ...
                                                            data-src="${currentProduct.image.src}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3 border rounded p-3">
                                                <div class="col-12">
                                                    ...
                                                    <div id="productPreviewContainer" data-src="">
                                                        <c:forEach var="img" items="${listImg}">
                                                            <img src="${img.image.src}" alt="Đây là ảnh sản phẩm nè">
                                                        </c:forEach>
                                                    </div>
                                                </div>
                                            </div>
