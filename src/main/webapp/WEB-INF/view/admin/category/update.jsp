<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>>
                <title>Cập nhật thể loại - Fruitables</title>
                            ...
                            <main class="mb-3">
                                <div class="container-fluid px-4">
                                    ...
                                    <div class="col col-md-10 mx-auto">
                                        <h3 class="mb-3">Sửa thể loại</h3>
                                        <hr>
                                        <form:form enctype="multipart/form-data" modelAttribute="currentCategory"
                                            ...
                                            <div class="col-12 mb-3">
                                                <img class="mx-auto" style="max-height: 250px; display: none;"
                                                    ...
                                                    data-src="${currentCategory.image.src}" />
                                            </div>
